...
public class AgentBuilder {
    ...
    public AgentBuilder(String agentId, String factionId) {
        entity = new Entity()
    ...
    public AgentBuilder withTag(String tag) {
        entity.add(new TagComponent(tag));
        return this;
    }

    public AgentBuilder withAI(BehaviorTask behaviorTask) {
        entity.add(new BehaviorComponent(behaviorTask));
        return this;
    }
